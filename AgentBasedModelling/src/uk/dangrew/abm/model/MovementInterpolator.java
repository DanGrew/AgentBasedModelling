...
/**
 * The {@link MovementInterpolator} is responsible for interpolating a general {@link Heading}
...
class MovementInterpolator {
   ...
   /**
    * Constructs a new {@link MovementInterpolator}. 
    */
   public MovementInterpolator(){} 
    ...
    */
   boolean moveForVelocity( Environment environment ) {
   ...
   private boolean interpolate( Environment environment, int vertical, int horizontal ) {
      ...
      if ( environment.isBoundary( new EnvironmentPosition( vertical, horizontal ) ) ) {
         return true;
      }
